...
var ngApp = angular.module('bsl', ['ngRoute', 'ngAnimate', 'ngSanitize']);

// common
function resolveFunc($q, $rootScope, $location) {
    var defer = $q.defer();
    $("#ngview").html("<h3>Memuat...</h3>");
    defer.resolve();
...
ngApp.config(function ($routeProvider, $locationProvider, $httpProvider) {
    $routeProvider.when('/page/:path_module', {
...
function repbooking_ctrl($rootScope, $scope) {
    ...
    $scope.exportExcel = function () {
        var a = [['#', 'Tanggal', 'Jenis Transaksi', 'No Induk', 'Sub Kode Sampah', 'Vol', 'Harga/Unit', 'Total', 'Saldo Akhir']];
...
function repcitizen_ctrl($rootScope, $scope) {
    ...
    $scope.exportExcel = function () {
        var a = [['#', 'Bulan', 'Nasabah', 'Sub Kategori Sampah', 'Total Vol', 'Total Rp', 'N x Trx']]
...
function repsubcat_ctrl($rootScope, $scope) {
    ...
    $scope.exportExcel = function () {
        var a = [['#', 'Bulan', 'Kode Sampah', 'Total Vol', 'Total Rp']]
        var d = $scope.trxBookingYearMonth;
...
function admin_repadmin_unittrx_ctrl($rootScope, $scope, $routeParams) {
    ...
    $scope.exportExcel = function () {
        var a = [["#", "Bulan", "Unit Bank", "Sub Kode Sampah", "Total Vol", "Total Rp", "N x Trx"]];
        var d = $scope.trxCitizensYearMonth;
...
function admin_repadmin_booking_ctrl($rootScope, $scope, $routeParams) {
    ...
    $scope.exportExcel = function () {
        var a = [['#', 'Tanggal', 'Jenis Transaksi', 'Unit Bank', 'Nasabah', 'Sub Kode Sampah', 'Vol',
...
function admin_repadmin_citizens_ctrl($rootScope, $scope) {
    ...
    $scope.exportExcel = function () {
        ...
        var a = [["#", "Nomer Induk", "nama", "Alamat", "Tlp", "Unit Bank Sampah", "Saldo"]];
