...
//init
class admin_repadmin_bookingPage
{
...
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Pembukuan Transaksi - Admin</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
...
?>
    ...
    <button ng-click="repAdmin_booking_load()">Proses</button>
        ...
        <div id="printdata">
            ...
            <table class="table table-bordered table-condensed">
                <tr>
                    ...
                    <td style="width: 100px;"><input type="text" ng-model="filter.sellerid1" style="width: 100%"></td>
                ...
                <tr ng-repeat="item in trxBookingYearMonth | filter: repAdminBookingFilter ">
                    <td>{{$index+1}}</td>
