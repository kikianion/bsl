...
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Rekapan berdasarkan nasabah</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
...
?>
    ...
    <button ng-click="getRepCitizen()">Proses</button>
        ...
        <div id="printdata">
            ...
            <table class="table table-bordered table-condensed">
                ...
                <tr ng-repeat="item in trxCitizensYearMonth | filter: repBookingFilter ">
                    ...
                    <td>{{$index>=1 ?
                        item.citizenid==trxCitizensYearMonth[$index-1].citizenid?"":item.citizenid+'-'+item.citizenname
                        : item.citizenid+'-'+item.citizenname}}
                    </td>
