...
<script type="text/javascript">
    ...
    (function (_SELF) {
        ...
        var hot_options = {
            colHeaders: ['', '_Dibawahi', '_Level', 'No Induk', 'Nama', '_Username', '_Password', 'Alamat', 'Telepon'],
            colWidths: [20, 1, 1, 100, 300, 1, 1, 200, 200],
            columns: [
                {
                    type: 'numeric',
                    readOnly: true,
        ...
        _SELF.hot = new HotSingle("hottable", hot_options, "citizens");
        _SELF.hot.build(
